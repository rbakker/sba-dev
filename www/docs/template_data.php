...
<li>rgbvolumes.json – the volume of each region in cubic millimeters. In newer files, it is computed in the variants 'left' (all parts of the region with x&lt;0), 'right' (all parts of the region with x&gt;0) and 'both' (all parts of the region).</li>
<li>rgbcenters_mm.json – the centerpoint of each region in stereotactic coordinates. The centerpoint is the center of gravity of the region. In newer files, it is computed in the variants 'left' (all parts of the region with x&lt;0), 'right' (all parts of the region with x&gt;0) and 'both' (all parts of the region).</li>
</ul>
</p><p>
